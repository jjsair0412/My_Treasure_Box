...
- [deepops]()
    - [deepops-k8s - deepops에서의 kubernetes](https://github.com/jjsair0412/kubernetes_info/tree/main/deepops/deepops-k8s)
        - [deepops-k8s-Provisioning - deepops로 k8s 배포](https://github.com/jjsair0412/kubernetes_info/blob/main/deepops/deepops-k8s/deepops-k8s-Provisioning.md)
        - [deepops-k8s-addNode - deepops로 노드 추가 방안](https://github.com/jjsair0412/kubernetes_info/blob/main/deepops/deepops-k8s/deepops-k8s-addNode.md)
        - [deepops-k8s-resouces 변경방안_runtime,cni 등.. - deepops에서 k8s resouce 변경 방안](https://github.com/jjsair0412/kubernetes_info/blob/main/deepops/deepops-k8s/deepops-k8s-resource%20%EB%B3%80%EA%B2%BD%EB%B0%A9%EC%95%88_runtime%2Ccni%20%EB%93%B1%2C%2C.md)
        - [deepops-k8s-versionUpgrade - deepops로 k8s version upgrade 하는 방법](https://github.com/jjsair0412/kubernetes_info/blob/main/deepops/deepops-k8s/deepops-k8s-versionUpgrade.md)
