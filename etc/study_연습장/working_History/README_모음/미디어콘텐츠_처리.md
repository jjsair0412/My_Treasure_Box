...
![class-diagram](http://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/jjsair0412/My_Treasure_Box/working_History/plantUmlDiagram/diagram.puml)
...
***단점 :***
    ...
    세그먼트 관리가 필요하며 , 전체 객체를 읽을 때 순차적으로 읽어와야 합니다.
